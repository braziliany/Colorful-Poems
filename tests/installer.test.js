...
assert.strictEqual(api.CONFIG.version, "1.1.1");
assert.strictEqual(api.extractVersion("// v1.1.1 Polish"), "1.1.1");
assert.strictEqual(api.compareVersions("1.2.0", "1.1.9"), 1);
assert.strictEqual(api.compareVersions("1.1.1", "1.1.1"), 0);
assert.strictEqual(api.compareVersions("1.0.9", "1.1.0"), -1);
assert(api.extractReleaseNotes("## 1.1.1\n\n- hello\n\n## 1.1.0\n- old", "1.1.1").includes("hello"));
